...
The data that we are using is a subset that I cut out of the CDC dataset of Community Health Status Indicators (CHSI).

You can play with the full dataset, available here:

http://www.healthdata.gov/dataset/community-health-status-indicators-chsi-combat-obesity-heart-disease-and-cancer

This is the CDC web tool for exploring the most recent CHSI data.
...
> ### Challenge
>
> Import the data from other two CSV files.
